...
using DivitOtoyol.Modules.Statistics.CameraStatistics.Features.CreatingCameraStatistic;
using DivitOtoyol.Modules.Statistics.CameraStatistics.Models;

namespace DivitOtoyol.Modules.Statistics.CameraStatistics;

public class CameraStatisticMappers : Profile
{
    public CameraStatisticMappers()
    {
        CreateMap<CameraStatistic, CameraStatisticDto>()
        ...
        CreateMap<CreateCameraStatistic, CameraStatistic>();

        CreateMap<CreateCameraStatisticRequest, CreateCameraStatistic>()
            .ConstructUsing(req => new CreateCameraStatistic(
                req.LocationId,
                req.LocationName,
                req.CameraId,
                req.CameraName,
