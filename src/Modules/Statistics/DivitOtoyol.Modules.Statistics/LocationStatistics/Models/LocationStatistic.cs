...
namespace DivitOtoyol.Modules.Statistics.LocationStatistics.Models;

public class LocationStatistic : Aggregate<LocationStatisticId>
{
    ...
    public static LocationStatistic Create(
        ...
        DateTime lprDate)
    {
        Guard.Against.Null(locationInformation, new LocationStatisticDomainException("LocationInformation cannot be null"));
        Guard.Against.Null(cameraInformation, new LocationStatisticDomainException("LocationInformation cannot be null"));
        Guard.Against.Null(typeInformation, new LocationStatisticDomainException("TypeInformation cannot be null"));
        Guard.Against.Null(makeInformation, new LocationStatisticDomainException("MakeInformation cannot be null"));
        Guard.Against.Null(modelInformation, new LocationStatisticDomainException("ModelInformation cannot be null"));
        Guard.Against.Null(colorInformation, new LocationStatisticDomainException("ColorInformation cannot be null"));

        var cameraStatistic = new LocationStatistic
        {
            Id = Guard.Against.Null(id, new LocationStatisticDomainException("Plate Statistic id can not be null")),
            LocationInformation = locationInformation,
            CameraInformation = cameraInformation,
            TypeInformation = typeInformation,
            MakeInformation = makeInformation,
        ...
        cameraStatistic.AddDomainEvents(new LocationStatisticCreated(cameraStatistic));
    ...
    {
        Guard.Against.Null(cameraInformation, new LocationStatisticDomainException("CameraInformation cannot be null"));
