...
namespace DivitOtoyol.Modules.Statistics.PlateStatistics.Data;

public class PlateStatisticEntityTypeConfiguration : IEntityTypeConfiguration<PlateStatistic>
{
    public void Configure(EntityTypeBuilder<PlateStatistic> builder)
    {
        builder.ToTable("plate_statistics", StatisticDbContext.DefaultSchema);
