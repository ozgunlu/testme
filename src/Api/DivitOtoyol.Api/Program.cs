...
using DivitOtoyol.Api;
using DivitOtoyol.Api.Extensions.ApplicationBuilderExtensions;
using DivitOtoyol.Api.Extensions.ServiceCollectionExtensions;
using DivitOtoyol.Modules.Cameras;
...
static void RegisterServices(WebApplicationBuilder builder)
{
    ...
    builder.Host.AddCustomSerilog(
        ...
        {
            config.WriteTo.File(
                DivitOtoyol.Api.Program.GetLogPath(builder.Environment, loggingOptions) ??
